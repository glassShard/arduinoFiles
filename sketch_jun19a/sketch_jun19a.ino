...
String url = "/watering/uploadSensorData.php";   // Change this for your own file
...
void loop() {
  ...
  String postData = "sensor={\"soil1\": 23, \"soil2\": 45, \"soil3\": 17, \"soil4\": 92}";
  ...
  if (!client.connect(server, 443))
    ...
    Serial.println(String("POST https://") + server + url + " HTTP/1.0");
    ...
    Serial.println("End of messaging");
    client.stop();
  }
}
